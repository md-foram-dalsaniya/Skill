...
function Experiance() {
  ...
  console.warn('add experience ',exps);
      ...
      case -1:
        return <table className='table-sm table-bordered text-monospace' style={{ width: '1000px', maxHeight: '450px' }}>
          <thead style={{ 'fontSize': '15px' }}>
            <tr>
              <th scope='col' style={{ width: '100px' }}><center>CompanyId</center></th>
              <th scope='col' style={{ width: '150px' }}><center>Start Date</center></th>
              <th scope='col' style={{ width: '150px' }}><center>End Date</center></th>
              <th scope='col' style={{ width: '150px' }}><center>Role</center></th>
              <th scope='col' style={{ width: '400px' }}></th>
            </tr>
          </thead>
          {exps.length > 0 && exps.map((item, i) => {
            return (
              <thead style={{ 'fontSize': '15px' }} i={i}>
                <tr>
                  <td><center>{item.id}</center></td>
                  <td><center>{moment.unix(item.startDate).format('YYYY/MM/DD')}</center></td>
                  <td><center>{moment.unix(item.endDate).format('YYYY/MM/DD')}</center></td>
